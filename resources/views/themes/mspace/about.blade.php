...
<div class="site_wrapper">
  <div class="topbar pink-2 white-2 topbar-padding">
    <div class="container">
  ...
  <div id="header">
    <div class="container">
      <div class="navbar pink navbar-default yamm">
        ...
        <div id="navbar-collapse-grid" class="navbar-collapse collapse pull-right">
          <ul class="nav pink navbar-nav">
            ...
            <li><a href="cares.html" class="dropdown-toggle">Our Cares</a></li>
 ...
 <section>
  ...
  <section class="sec-padding">
    <div class="container">
      <div class="row no-gutter">
        <div class="col-md-6"><img src="http://placehold.it/600x500" alt="" class="img-responsive"/></div>
        <div class="col-md-6">
  ...
  <section>
    <div class="container">
      ...
      <div class="clearfix"></div>
      <div class="row no-gutter sec-padding">
         <div class="col-xs-12 text-center">
          <h2 class=" raleway">Meet Our Experts</h2>
          <div class="title-line-4 pink less-margin align-center"></div>
          <p class="sub-title-2">Lorem ipsum dolor sit amet consectetuer adipiscing elit Suspendisse et justo Praesent mattis commodo augue .</p>
        </div>
        <div class="clearfix"></div>
        <!--end title-->
        
        <div class="col-md-3 col-sm-6">
          <div class="team-holder12 three text-center bmargin">
            <div class="image-holder">
              <div class="hover-box">
                <p class="text-white"> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent mattis aliquet purus non elementum.</p>
              </div>
              <img src="http://placehold.it/300x320" alt="" class="img-responsive"/> </div>
            <div class="clearfix"></div>
            <br/>
            <h4 class="less-mar1 raleway">Elizabeth</h4>
            <span>Fashion Model</span> </div>
        </div>
        <!--end item-->
        ...
        <div class="col-md-3 col-sm-6">
          <div class="team-holder12 three text-center bmargin">
            ...
            <div class="clearfix"></div>
            <br/>
            <h4 class="less-mar1 raleway">Alexander</h4>
        ...
        <div class="col-md-3 col-sm-6">
          <div class="team-holder12 three text-center bmargin">
            ...
            <div class="clearfix"></div>
            <br/>
            <h4 class="less-mar1 raleway">Addison</h4>
            <span>Fashion Designer</span> </div>
        </div>
        <!--end item-->
        ...
        <div class="col-md-3 col-sm-6">
          <div class="team-holder12 three text-center bmargin">
            ...
            <div class="clearfix"></div>
            <br/>
            <h4 class="less-mar1 raleway">Benjamin</h4>
            <span>Photographer</span> </div>
        </div>
        <!--end item--> 
  ...
  <section class="section-copyrights sec-moreless-padding">
    <div class="container">
      <div class="row">
        <div class="col-md-12"> <span>Copyright © 2015 l yourdomain.com. All rights reserved.</span></div>
      </div>
    </div>
  </section>
  <!--end section-->
  ...
  <a href="#" class="scrollup pink"></a><!-- end scroll to top of the page--> 
</div>
<!-- end site wraper --> 
