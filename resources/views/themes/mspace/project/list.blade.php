              ...
              <div class="row">
                <div class="col-md-8">
                  ...
                  <article class="post post-5 clearfix">
                    <div class="entry-media"><a href="{{App\Helpers\Theme::assetsPath('assets/media/content/post/340x310/1.jpg')}}" class="prettyPhoto"><img src="{{$item->image}}" style="width:340px; height:310px" alt="Foto" class="img-responsive"/></a></div>
                    <div class="entry-main">
                      ...
                      <div class="entry-meta"><span class="entry-meta__item">By<a href="{{route('detail_project',$item->slug)}}" class="entry-meta__slug"> greenhouse</a></span><span class="entry-meta__item"><a href="{{route('detail_project',$item->slug)}}" class="entry-meta__slug"></a></span><span class="entry-meta__item"><i class="icon pe-7s-comment"></i><a href="{{route('detail_project',$item->slug)}}" class="entry-meta__slug"></a></span></div>
                      <div class="entry-content">
                        <p>{!!App\Helpers\Theme::truncateWords(strip_tags($item->body), 98)!!}</p>
                      </div>
                      <div class="entry-footer"><a href="{{route('detail_project',$item->slug)}}" class="btn-slug">Đọc tiếp</a></div>
                    </div>
                  </article>
                  @endforeach
                      ...
                      <div class="widget-content">
                        ...
                        <article class="post post-3 post-3_mod-a clearfix">
                          ...
                          <div class="entry-main">
                            ...
                            <h2 class="entry-title"><a href="{{route('detail_project',$item->slug)}}">{{$item1->title}}</a></h2>
                            </div>
                            @if ($item1->project_category_id == 1)
                            <div class="entry-meta"><span class="category color-4">đọc tiếp</span><span class="entry-meta__item"><i class="icon pe-7s-comment"></i><a href="{{route('detail_project',$item->slug)}}" class="entry-meta__slug">greenhouse</a></span></div>
                            @endif
                            @if ($item1->project_category_id == 2)
                            <div class="entry-meta"><span class="category color-7">đọc tiếp</span><span class="entry-meta__item"><i class="icon pe-7s-comment"></i><a href="{{route('detail_project',$item->slug)}}" class="entry-meta__slug">greenhouse</a></span></div>
                            @endif
                            @if ($item1->project_category_id == 3)
                            <div class="entry-meta"><span class="category color-4">đọc tiếp</span><span class="entry-meta__item"><i class="icon pe-7s-comment"></i><a href="{{route('detail_project',$item->slug)}}" class="entry-meta__slug">greenhouse</a></span></div>
                            @endif
                            @if ($item1->project_category_id == 4)
                            <div class="entry-meta"><span class="category color-12">đọc tiếp</span><span class="entry-meta__item"><i class="icon pe-7s-comment"></i><a href="{{route('detail_project',$item->slug)}}" class="entry-meta__slug">greenhouse</a></span></div>
                            @endif
                          </div>
                        </article>
                        @endforeach
                        ...
                        <div class="tab-content">
                          <div id="tab-2-1" class="tab-pane fade in active">
                            <article class="post post-3 post-3_mod-e clearfix">
                              ...
                              <div class="entry-main">
                                <div class="entry-header">
                                  <h2 class="entry-title"><a href="{{route('detail_project',$item->slug)}}">Aliquip exea comod rure nsewuat duis</a></h2>
                                </div>
                                <div class="entry-meta"><span class="category color-7">health</span><span class="entry-meta__item"><i class="icon pe-7s-comment"></i><a href="{{route('detail_project',$item->slug)}}" class="entry-meta__slug">12</a></span></div>
                              </div>
                            </article>
                            <article class="post post-3 post-3_mod-e clearfix">
                              ...
                              <div class="entry-main">
                                <div class="entry-header">
                                  <h2 class="entry-title"><a href="{{route('detail_project',$item->slug)}}">Perspiciatis unde omnist enatus error sit</a></h2>
                                </div>
                                <div class="entry-meta"><span class="category color-5">world</span><span class="entry-meta__item"><i class="icon pe-7s-comment"></i><a href="{{route('detail_project',$item->slug)}}" class="entry-meta__slug">12</a></span></div>
                              </div>
                            </article>
                            <article class="post post-3 post-3_mod-e clearfix">
                              ...
                              <div class="entry-main">
                                <div class="entry-header">
                                  <h2 class="entry-title"><a href="{{route('detail_project',$item->slug)}}">Volupta tem acusa ntium dolore me laud</a></h2>
                                </div>
                                <div class="entry-meta"><span class="category color-12">sports</span><span class="entry-meta__item"><i class="icon pe-7s-comment"></i><a href="{{route('detail_project',$item->slug)}}" class="entry-meta__slug">12</a></span></div>
                              </div>
                            </article>
                            <article class="post post-3 post-3_mod-e clearfix">
                              ...
                              <div class="entry-main">
                                ...
                                <div class="entry-meta"><span class="category color-2">technology</span><span class="entry-meta__item"><i class="icon pe-7s-comment"></i><a href="{{route('detail_project',$item->slug)}}" class="entry-meta__slug">12</a></span></div>
                              </div>
                            </article>
                          </div>
