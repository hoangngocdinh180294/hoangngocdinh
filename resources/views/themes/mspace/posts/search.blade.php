                      ...
                      <div class="widget-content">
                        ...
                        <article class="post post-3 post-3_mod-a clearfix">
                          ...
                          <div class="entry-main">
                            ...
                            <div class="entry-meta"><span class="category color-4">đọc tiếp</span><span class="entry-meta__item"><i class="icon pe-7s-comment"></i><a href="{{route('detail_project',$item1->slug)}}" class="entry-meta__slug">greenhouse</a></span></div>
                            @endif
                            @if ($item1->project_category_id == 2)
                            <div class="entry-meta"><span class="category color-7">đọc tiếp</span><span class="entry-meta__item"><i class="icon pe-7s-comment"></i><a href="{{route('detail_project',$item1->slug)}}" class="entry-meta__slug">greenhouse</a></span></div>
                            @endif
                            @if ($item1->project_category_id == 3)
                            <div class="entry-meta"><span class="category color-4">đọc tiếp</span><span class="entry-meta__item"><i class="icon pe-7s-comment"></i><a href="{{route('detail_project',$item1->slug)}}" class="entry-meta__slug">greenhouse</a></span></div>
                            @endif
                            @if ($item1->project_category_id == 4)
                            <div class="entry-meta"><span class="category color-12">đọc tiếp</span><span class="entry-meta__item"><i class="icon pe-7s-comment"></i><a href="{{route('detail_project',$item1->slug)}}" class="entry-meta__slug">greenhouse</a></span></div>
                            @endif
                          </div>
                        </article>
                        @endforeach
