                  ...
                  <div class="block-content block-content-full d-flex justify-content-between border-bottom">
                      <div>
                          <nav aria-label="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Ý kiến khách hàng</li>
                                    <li class="breadcrumb-item active" aria-current="page" v-if="isEdit">Sửa Ý kiến khách hàng</li>
                                    <li class="breadcrumb-item active" aria-current="page" v-else>Tạo Ý kiến khách hàng</li>
...
export default {
  ...
  created() {
    if (this.isEdit) {
      const id = this.$route.params && this.$route.params.testimonial;
      this.getData(id)
    } else {
