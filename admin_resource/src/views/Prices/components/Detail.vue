                          ...
                          <div id="settings-accordion_s7" class="collapse" role="tabpanel" aria-labelledby="settings-accordion_h7" data-parent="#settings-accordion">
                              <div class="block-content">
                                  <div class="form-group">
                                      ...
                                      <div class="font-size-sm text-muted mb-2">Hiển thị thẻ meta description cho bảng giá</div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="font-size-sm text-muted mb-2">Những từ khoá cho bảng giá</div>
              ...
              <div class="block block-fx-pop">
                  <div class="block-content block-content-full d-flex justify-content-between border-bottom">
                      <div>
                          <nav aria-label="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><router-link :to="'/prices'">Báo giá dịch vụ</router-link></li>
                                    <li class="breadcrumb-item active" aria-current="page" v-if="isEdit">Sửa / {{currentForm.title}}</li>
                  ...
                  <div class="block-content">
                      <form method="POST" onsubmit="return false;">
                          ...
                          <div class="form-group">
                              <input v-model="currentForm.price" type="text" class="form-control py-4" id="post-price" name="post-price" placeholder="Báo giá ...">
                          </div>
                          <div class="form-group">
...
<script>
import { getApi, createApi, updateApi } from '@/api/prices'
...
export default {
  ...
  created() {
    if (this.isEdit) {
      const id = this.$route.params && this.$route.params.price
    ...
    submitForm() {
      // if(this.$refs.currentxForm.validate()) {
          ...
          this.submitFormRequest(this.currentForm).then((response) => {
            ...
            if (!this.isEdit) {
              this.$router.replace('/prices/edit/' + response.id)
            }
          },
          () => {
            this.loading = false
